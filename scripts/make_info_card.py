...
LINES = [
    ...
    [],
    [("─ Skills & Technologies", ACCENT, True)],
    [("Languages: Python, C++", FG, False)],
    [("LLM & AI Systems: LangChain, LangGraph, Google Generative AI,", FG, False)],
    [("     Unsloth, QLoRA Fine-Tuning, vLLM, llama.cpp (GGUF),", FG, False)],
    [("     Model Quantization, On-Premise LLM Deployment", FG, False)],
    [("Machine Learning: TensorFlow, Supervised Learning, Predictive Modeling,", FG, False)],
    [("     Classification, scikit-learn, Unsupervised Learning,", FG, False)],
    [("Cloud & DevOps: Docker, GCP, Jenkins", FG, False)],
    [("Database: MySQL, PostgreSQL, MS Access, MS SQL Server, Redis.", FG, False)]
]
